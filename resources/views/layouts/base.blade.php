...
<link rel="icon" href="asset/logoBank.png" type="image/png">
...
<body>
    ...
    <div class="custom-box" id="customBox"></div>
            ...
            <a href="/welcome" class="logo-link">
             <img style="margin-left:80%;" class="logo" src="{{ asset('asset/logoBank.png') }}" alt="Logo Bank">
     
                </a>

            <div class="options-area">
                @auth
    <a id="saldo">Saldo Rp. {{ number_format(auth()->user()->saldo, 0, ',', '.') }},00<i style="margin-left:2px;" class="fas fa-caret-down"></i>
        <div class="dropdown-content">
            <button style="color: #000;" onclick="showTopupForm()">Topup</button>
        </div>
    </a>
    <a style="margin-left:2px;" href="/none" id="Post" class="nav-link">Your Post</a>
@endauth

            <a href="#second" id="tentang"class="nav-link">About</a>  
...
@endauth
    ...
    var donationPageRegex = /^\/donationPage\/\d+$/; // Regex untuk mencocokkan pola '/donationPage/{angka}'
